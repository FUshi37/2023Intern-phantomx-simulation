...
import gym
import argparse
from src.Algorithm.PPOMAX.normalization import Normalization, RewardScaling
from src.Algorithm.PPOMAX.replaybuffer import ReplayBuffer
from src.Algorithm.PPOMAX.ppo_continuous import PPO_continuous
...
def main(args, env_name, number, seed):
    env = PhantomxGymEnv()
    env_evaluate = PhantomxGymEnv()  # When evaluating the policy, we need to rebuild an environment
    # Set random seed
    env.seed(seed)
...
if __name__ == '__main__':
    ...
    env_name = ['BipedalWalker-v3', 'HalfCheetah-v2', 'Hopper-v2', 'Walker2d-v2', 'Phantomx-v0']
    env_index = 4
