...
if __name__ == "__main__":
    ...
    # 100HZ控制帧率 + 非标准化环境
    tb_log_name = "NUCPPO-TrackVelocity-100HZ-xvelP"
...
# -----------------------------加载模型检验时注释该部分--------------------------------
    ...
    model.learn(
        ...
        total_timesteps=24*300*5000, reset_num_timesteps=True, tb_log_name=tb_log_name, callback=callback
    ...
    model.save(log_dir + "NUCppo_phantomx_trackvel")
